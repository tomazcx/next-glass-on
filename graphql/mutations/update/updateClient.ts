...
export const UPDATE_CLIENT = gql`
    mutation UpdateClient($id:ID!,$birthDate: String, $cep: String, $city: String, $complement: String, $cpf:String, $district: String, $houseNum: String, $email: String, $name: String, $street: String, $building:String, $state: String) {
        updateClient(
